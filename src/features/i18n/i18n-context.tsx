  ...
  es: {
    ...
    appShell: {
      ...
      navigation: {
        ...
        evaluations: { label: "Evaluaciones", summary: "Pruebas cargadas por grupo, resultados por estudiante y seguimiento pedagógico." },
        ...
        profiles: { label: "Jugadores", summary: "Jugadores, tarjetas asociadas y actividad registrada." },
  ...
  en: {
    ...
    appShell: {
      ...
      navigation: {
        ...
        evaluations: { label: "Evaluations", summary: "Group assessments, per-student results and educational follow-up." },
        ...
        profiles: { label: "Players", summary: "Players, linked cards, and recorded activity." },
  ...
  pt: {
    ...
    appShell: {
      ...
      navigation: {
        ...
        evaluations: { label: "Avaliações", summary: "Provas por grupo, resultados por estudante e acompanhamento pedagógico." },
        ...
        profiles: { label: "Jogadores", summary: "Jogadores, cartões associados e atividade registrada." },
