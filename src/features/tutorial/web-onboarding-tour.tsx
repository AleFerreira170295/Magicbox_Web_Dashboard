    ...
    case "family":
      return finalizeTutorialSteps(user, [
        buildStep(
          ...
          Sparkles,
          [
            tr("Tu dashboard resume partidas y syncs visibles.", "Your dashboard summarizes visible games and syncs.", "Seu dashboard resume partidas e syncs visíveis."),
        ...
        buildStep(
          "games",
          tr("Partidas", "Games", "Partidas"),
          tr("Este módulo concentra la lectura principal: sesiones recientes, jugadores y uso visible.", "This module concentrates the main reading: recent sessions, players, and visible usage.", "Este módulo concentra a leitura principal: sessões recentes, jogadores e uso visível."),
          Database,
          [
            ...
            tr("La vista evita administración y operación técnica.", "The view avoids administration and technical operation.", "A visão evita administração e operação técnica."),
          ],
          { href: "/games", ctaLabel: tr("Ver partidas", "View games", "Ver partidas"), badge: tr("Seguimiento", "Follow-up", "Acompanhamento") },
        ),
        buildStep(
          "syncs",
          tr("Sincronizaciones", "Syncs", "Sincronizações"),
          tr("El cierre del circuito está en syncs recientes, sin necesidad de entrar a ACL, salud, usuarios ni configuración global.", "The loop closes with recent syncs, without needing ACL, health, users, or global settings.", "O fechamento do circuito está em syncs recentes, sem precisar entrar em ACL, saúde, usuários nem configuração global."),
          Cable,
          [
            ...
            tr("La evidencia raw queda visible cuando la app la pudo enviar.", "Raw evidence is visible when the app could send it.", "A evidência raw fica visível quando o app conseguiu enviá-la."),
          ],
          { href: "/syncs", ctaLabel: tr("Ver syncs", "View syncs", "Ver syncs"), badge: tr("Contexto", "Context", "Contexto") },
        ),
      ]);
    case "teacher":
    default:
