...
export function SuperadminDashboard() {
  ...
  const smartPresets = useMemo(
    ...
    [localText.smartPreset.all, localText.smartPreset.critical, localText.smartPreset.highPopulationLowActivity, localText.smartPreset.noTurns, localText.smartPreset.scoreLt60, territoryAlerts, territoryScores],
  );
