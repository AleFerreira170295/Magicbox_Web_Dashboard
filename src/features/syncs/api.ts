...
function normalizeLegacySession(input: unknown): SyncSessionRecord {
  ...
  return {
    id: String(record.id || ""),
    userId: (record.user_id as string | undefined) || null,
    ...
    status: ((record.sync_status || record.status) as string | undefined) || null,
    ...
    appVersion: (record.app_version as string | undefined) || null,
    payloadSchemaVersion: (record.payload_schema_version as string | undefined) || null,
    ...
    rawRecordCount: typeof record.raw_record_count === "number" ? record.raw_record_count : Number(record.raw_record_count || 0),
    lastRawRecordId: (record.last_raw_record_id as string | undefined) || null,
    ...
    rawFragmentCount: typeof record.raw_fragment_count === "number" ? record.raw_fragment_count : Number(record.raw_fragment_count || 0),
    additionalFields: asRecord(record.session_metadata),
    receivedAt: (record.received_at as string | undefined) || null,
